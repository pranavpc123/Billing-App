...
CREATE TABLE "new_BusinessSettings" (
    ...
    "whatsappInvoiceTemplateName" TEXT NOT NULL DEFAULT 'invoice_notification',
    "whatsappQuoteTemplateName" TEXT NOT NULL DEFAULT 'quote_notification',
